...
- [rpg_trajectory_evaluation](#rpg_trajectory_evaluation)
  - [Install](#install)
  ...
  - [Run the Evaluation](#run-the-evaluation)
    - [Single trajectory estimate](#single-trajectory-estimate)
      ...
      - [Advanced: Different estimation type](#advanced-different-estimation-type)
    - [Multiple trajectory estimates](#multiple-trajectory-estimates)
      - [Datasets organization](#datasets-organization)
        - [Specifying sub-trajectory lengths for relative pose errors](#specifying-sub-trajectory-lengths-for-relative-pose-errors)
      - [Output](#output-1)
