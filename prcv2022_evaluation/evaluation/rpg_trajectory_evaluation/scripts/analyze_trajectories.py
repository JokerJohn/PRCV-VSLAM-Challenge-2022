...
if __name__ == '__main__':
    ...
    parser.add_argument('--platform',
                        help='HW platform: [laptop, nuc, odroid, up]',
                        default='laptop')
    ...
    datasets_res_dir = {}
    for d in datasets:
        cur_res_dir = os.path.join(output_dir,
                                   '{}_{}_results'.format(args.platform, d))
    ...
    for config_i in algorithms:
        ...
        for d in datasets:
            ...
            trace_dir = os.path.join(args.results_dir, args.platform, config_i,
                                     exp_name)
