...
class MulTrajError(object):
    ...
    def __init__(self):
        self.abs_errors = {'rmse_trans': [], 'rmse_rot': [], 'rmse_scale': []}
        self.rmse_trans = []
        self.rmse_rot = []
        self.rmse_scale = []
        self.rel_errors = {}
        ...
        if self.abs_errors:
            with open(
                    os.path.join(
                        ...
                        'mt_cached_abs_err_' + self.align_str + '.pickle'),
                    'wb') as f:
                pickle.dump(self.abs_errors, f)
        if self.rel_errors:
            with open(
                    os.path.join(self.cache_results_dir,
    ...
    def get_relative_errors_and_distances(self,
        ...
        for err_i in error_types:
            ...
            rel_errors[err_i] = [[
                self.rel_errors[d][err_i] for d in self.rel_distances
            ]]
